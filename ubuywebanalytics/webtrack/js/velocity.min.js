              ...
              if (!$.isPlainObject(h) || g.isEmptyObject(h)) {
                if (g.isString(h) && v.Redirects[h]) {
                  ...
                  return (
                    ...
                    $.each(m, function (e, t) {
                      (parseFloat(F.stagger) ? (F.delay = j + parseFloat(F.stagger) * e) : g.isFunction(F.stagger) && (F.delay = j + F.stagger.call(t, e, P)), F.drag && ((F.duration = parseFloat(E) || (/^(callout|transition)/.test(h) ? 1e3 : y)), (F.duration = Math.max(F.duration * (F.backwards ? 1 - e / P : (e + 1) / P), 0.75 * F.duration, 200))), v.Redirects[h].call(t, t, F || {}, e, P, m, T.promise ? T : a));
                    }),
                    e()
                  );
                }
